    ...
    match (&struct_.fields, parse_flat) {
        (syn::Fields::Named(_), Some(parse_flat)) => {
            ...
            let accepts_all = struct_attr
                ...
                .into_iter();
            extra.get_or_insert_with(TokenStream::new).extend(quote_spanned! { Span::mixed_site() =>
